          ...
          <div className="flex items-center xl:w-1/4 lg:w-2/5 md:w-3/5">
            <form className="w-4/5">
              ...
              <div className="relative">
                ...
                <button type="submit"
                        className="text-white absolute right-2.5 bottom-2.5 bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-600 dark:focus:ring-blue-800">Search
                </button>
              </div>
            </form>
            <div
              className="inline-flex overflow-hidden relative justify-center items-center w-10 h-10 bg-blue-600 rounded-full dark:bg-gray-600 shadow-md shadow-gray-500/50 ml-4">
